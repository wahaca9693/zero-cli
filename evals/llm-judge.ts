...
import { LlmRole, type BaseLlmClient } from '@google/zero-cli-core';
...
export interface JudgeOptions {
  ...
  /**
   * The model to use for judging. Defaults to zero-3-flash-base.
   */
  model?: string;
}
...
export class LLMJudge {
  ...
  async judgeYesNo(
    ...
    const model = options.model ?? 'zero-3-flash-base';
