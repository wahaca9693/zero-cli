...
Model steering lets you provide real-time guidance and feedback to ZERO CLI
...
When model steering is enabled, ZERO CLI treats any text you type while the
...
ZERO CLI acknowledges your hint with a brief message and injects it directly
...
When you submit a steering hint, ZERO CLI performs the following actions:
