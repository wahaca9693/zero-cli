...
This guide details the Model Configuration system within ZERO CLI. Designed
...
| :---------------------- | :------- | :------------------------------------------------------------------------ |
| `model`                 | `string` | The identifier of the model to be called (for example, `zero-2.5-pro`). |
  ...
  "overrides": [
    {
      ...
      "modelConfig": {
        "model": "zero-2.5-pro-experimental-001"
      }
    }
  ]
}
