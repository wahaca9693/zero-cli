...
Keep complex jobs on the rails with ZERO CLI's built-in task planning. In this
...
ZERO will analyze your codebase and use the `write_todos` tool to generate a
structured list.
