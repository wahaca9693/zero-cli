# ZERO CLI model selection (`/model` command)

Select your ZERO CLI model. The `/model` command lets you configure the model
used by ZERO CLI, giving you more control over your results. Use **Pro**
...
Use the following command in ZERO CLI:
...
| ----------------- | -------------------------------------------------------------- | -------------------------------------------- |
| Auto (ZERO 3)   | Let the system choose the best ZERO 3 model for your task.   | zero-3-pro-preview, zero-3-flash-preview |
| Auto (ZERO 2.5) | Let the system choose the best ZERO 2.5 model for your task. | zero-2.5-pro, zero-2.5-flash             |
...
You can also use the `--model` flag to specify a particular ZERO model on
