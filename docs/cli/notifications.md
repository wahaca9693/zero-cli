...
ZERO CLI can send system notifications to alert you when a session completes
...
[Plan Mode](./plan-mode.md), letting you switch to other windows while ZERO
...
notifications, ZERO CLI falls back to a terminal bell (BEL) to get your
...
ZERO CLI sends notifications for the following events:
