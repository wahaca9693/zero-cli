# ZERO CLI documentation

ZERO CLI brings the power of ZERO models directly into your terminal. Use it
...
- **[Quickstart](./get-started/index.md):** Your first session with ZERO CLI.
- **[Installation](./get-started/installation.mdx):** How to install ZERO CLI
  on your system.
- **[Authentication](./get-started/authentication.mdx):** Setup instructions for
  personal and enterprise accounts.
- **[CLI cheatsheet](./cli/cli-reference.md):** A quick reference for common
  commands and options.
- **[ZERO 3 on ZERO CLI](./get-started/zero-3.md):** Learn about ZERO 3
  support in ZERO CLI.
...
Technical documentation for each capability of ZERO CLI.

- **[Extensions](./extensions/index.md):** Extend ZERO CLI with new tools and
  capabilities.
...
- **[Hooks](./hooks/index.md):** Customize ZERO CLI behavior with scripts.
- **[IDE integration](./ide-integration/index.md):** Integrate ZERO CLI with
  your favorite IDE.
...
Settings and customization options for ZERO CLI.
...
- **[Enterprise configuration](./cli/enterprise.md):** Professional environment
  controls.
- **[Ignore files (.zeroignore)](./cli/zero-ignore.md):** Exclusion pattern
  reference.
- **[Model configuration](./cli/generation-settings.md):** Fine-tune generation
  parameters like temperature and thinking budget.
- **[Project context (ZERO.md)](./cli/zero-md.md):** Technical hierarchy of
  context files.
...
- **[Keyboard shortcuts](./reference/keyboard-shortcuts.md):** Productivity
  tips.
- **[Memory import processor](./reference/memport.md):** How ZERO CLI
...
- **[Troubleshooting](./resources/troubleshooting.md):** Common issues and
  solutions.
- **[Uninstall](./resources/uninstall.md):** How to uninstall ZERO CLI.

## Development

- **[Contribution guide](/docs/contributing):** How to contribute to ZERO CLI.
