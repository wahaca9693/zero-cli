...
ZERO CLI uses tools to interact with your local environment, access
...
## How to use ZERO CLI's tools

Tools are generally invoked automatically by ZERO CLI when it needs to perform
an action. However, you can also trigger specific tools manually using shorthand
syntax.

### Automatic execution and security

When the model wants to use a tool, ZERO CLI evaluates the request against its
security policies.
...
| Tool                                             | Kind    | Description                                                                          |
| :----------------------------------------------- | :------ | :----------------------------------------------------------------------------------- |
| [`activate_skill`](../tools/activate-skill.md)   | `Other` | Loads specialized procedural expertise from the `.zero/skills` directory.          |
| [`get_internal_docs`](../tools/internal-docs.md) | `Think` | Accesses ZERO CLI's own documentation for accurate answers about its capabilities. |
...
| `glob`                   | `pattern`, `dir_path`, `case_sensitive`, `respect_git_ignore`, `respect_zero_ignore`                                                                                                               |
...
You can extend ZERO CLI with custom tools by configuring
