...
The `activate_skill` tool lets ZERO CLI load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. ZERO CLI uses this
...
The `activate_skill` tool is used exclusively by the ZERO agent. You cannot
