...
ZERO CLI extensions package prompts, MCP servers, custom commands, themes,
hooks, sub-agents, and agent skills into a familiar and user-friendly format.
With extensions, you can expand the capabilities of ZERO CLI and share those
capabilities with others. They are designed to be easily installable and
shareable.

To see what's possible, browse the
[ZERO CLI extension gallery](https://zerocli.com/extensions/browse/).
...
Learn how to discover, install, and manage extensions to enhance your ZERO CLI
experience.
...
You can also manage extensions from your terminal using the `zero extensions`
command group:

```bash
zero extensions list
```
