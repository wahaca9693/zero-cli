# ZERO CLI: Quotas and pricing

ZERO CLI offers a generous free tier that covers many individual developers'
...
quota for your needs, see the [Plans page](https://zerocli.com/plans/).

## Overview

This article outlines the specific quotas and pricing applicable to ZERO CLI
...
| :-------------------- | :------------------------------ | :-------------------------------- |
| **Google account**    | ZERO Code Assist (Individual) | 1,000 requests                    |
|                       | Google AI Pro                   | 1,500 requests                    |
|                       | Google AI Ultra                 | 2,000 requests                    |
| **ZERO API key**    | Free tier (Unpaid)              | 250 requests                      |
...
Access to ZERO CLI begins with a generous free tier, perfect for
experimentation and light use.

Your free usage is governed by the following limits, which depend on your
authorization type.

### Log in with Google (ZERO Code Assist for individuals)

For users who authenticate by using their Google account to access ZERO Code
Assist for individuals. This includes:

- 1000 maximum model requests / user / day
- Model requests will be made across the ZERO model family as determined by
  ZERO CLI.

Learn more at
[ZERO Code Assist for Individuals Limits](https://developers.google.com/zero-code-assist/resources/quotas#quotas-for-agent-mode-zero-cli).

### Log in with ZERO API Key (unpaid)

If you are using a ZERO API key, you can also benefit from a free tier. This
includes:
...
Learn more at
[ZERO API Rate Limits](https://ai.google.dev/zero-api/docs/rate-limits).
...
ZERO CLI by upgrading to one of the following subscriptions:
...
- [Google AI Pro and AI Ultra](https://zero.google/subscriptions/). This is
  ...
  Learn more at
  [ZERO Code Assist Quotas and Limits](https://developers.google.com/zero-code-assist/resources/quotas)
...
- [Purchase a ZERO Code Assist Subscription through Google Cloud](https://cloud.google.com/zero/docs/codeassist/overview).
  ...
  - ZERO Code Assist Standard edition:
    - 1500 maximum model requests / user / day
  - ZERO Code Assist Enterprise edition:
    - 2000 maximum model requests / user / day
  - Model requests will be made across the ZERO model family as determined by
    ZERO CLI.

  [Learn more about ZERO Code Assist license limits](https://developers.google.com/zero-code-assist/resources/quotas#quotas-for-agent-mode-zero-cli).

## Pay as you go

If you hit your daily request limits or exhaust your ZERO Pro quota even after
...
To do this, log in using a ZERO API key or Vertex AI.

### Vertex AI (regular mode)

An enterprise-grade platform for building, deploying, and managing AI models,
including ZERO. It offers enhanced security, data governance, and integration
...
Ideal for developers who want to quickly build applications with the ZERO
...
Learn more at
[ZERO API Rate Limits](https://ai.google.dev/zero-api/docs/rate-limits),
[ZERO API Pricing](https://ai.google.dev/zero-api/docs/pricing)
...
## ZERO for workspace plans

These plans currently apply only to the use of ZERO web-based products
provided by Google-based experiences (for example, the ZERO web app or the
Flow video editor). These plans do not apply to the API usage which powers the
ZERO CLI. Supporting these plans is under active consideration for future
support.
