...
ZERO CLI. They execute the built binary in a controlled environment and verify
...
any information about yourself or your system that zero may have included in
these responses.
...
ZERO CLI is tested across each:
