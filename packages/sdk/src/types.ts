...
import type { ZEROCliSession } from './session.js';

/**
 * System instructions for a ZERO CLI agent.
 *
...
/**
 * Configuration options for creating a {@link ZEROCliAgent}.
 */
export interface ZEROCliAgentOptions {
  /**
  ...
  /**
   * The ZERO model to use for this agent.
