# ZERO CLI Test Utils (`@google/zero-cli-test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from '@google/zero-cli-test-utils';
...
Import from `@google/zero-cli-test-utils` in test files across the monorepo.
