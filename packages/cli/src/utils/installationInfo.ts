...
import { debugLogger, isGitRepository } from '@google/zero-cli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.volta/') || realPath.includes('/Volta/')) {
      const updateCommand = 'volta install @google/zero-cli@latest';
      return {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @google/zero-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @google/zero-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @google/zero-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @google/zero-cli@latest';
    return {
