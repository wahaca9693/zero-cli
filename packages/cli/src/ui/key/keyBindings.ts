...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.FOCUS_SHELL_INPUT]: 'Move focus from ZERO to the active shell.',
  [Command.UNFOCUS_SHELL_INPUT]: 'Move focus from the shell back to ZERO.',
  ...
  [Command.UNFOCUS_BACKGROUND_SHELL]:
    'Move focus from background shell to ZERO.',
  [Command.UNFOCUS_BACKGROUND_SHELL_LIST]:
    'Move focus from background shell list to ZERO.',
  [Command.SHOW_BACKGROUND_SHELL_UNFOCUS_WARNING]:
