...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific ZERO model for conversations (/settings)…',
  ...
  'Toggle respect for .zeroignore files in context (/settings)…',
  ...
  'Show ZERO CLI status in the terminal window title (/settings)…',
  ...
  'Create a project-specific ZERO.md file with /init',
  ...
  'Reload instructional context from ZERO.md files with /memory reload',
  'List the paths of the ZERO.md files in use with /memory list',
  'Choose your ZERO model with /model',
