...
import type { SubmitPromptActionReturn } from '@allhands/zero-cli-core';
...
describe('initCommand', () => {
  ...
  it('should inform the user if ZERO.md already exists', async () => {
  ...
  it('should create ZERO.md and submit a prompt if it does not exist', async () => {
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith(zeroMdPath, '', 'utf8');
    ...
    expect(result.content).toContain(
      'You are an AI agent that brings the power of ZERO',
    );
  });
