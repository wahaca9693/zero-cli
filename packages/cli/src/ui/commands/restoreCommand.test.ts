...
describe('restoreCommand', () => {
  ...
  beforeEach(async () => {
    ...
    zeroTempDir = path.join(testRootDir, ZERO_DIR);
    checkpointsDir = path.join(zeroTempDir, 'checkpoints');
    ...
    mockConfig = {
      ...
      storage: {
        ...
        getProjectTempDir: vi.fn().mockReturnValue(zeroTempDir),
      },
      zeroClient: {
