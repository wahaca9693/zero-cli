...
export const GITHUB_WORKFLOW_PATHS = [
  ...
  'zero-assistant/zero-invoke.yml',
  'zero-assistant/zero-plan-execute.yml',
  'issue-triage/zero-triage.yml',
  'issue-triage/zero-scheduled-triage.yml',
  'pr-review/zero-review.yml',
];

export const GITHUB_COMMANDS_PATHS = [
  'zero-assistant/zero-invoke.toml',
  'zero-assistant/zero-plan-execute.toml',
  'issue-triage/zero-scheduled-triage.toml',
  'issue-triage/zero-triage.toml',
  'pr-review/zero-review.toml',
];

const REPO_DOWNLOAD_URL =
  'https://raw.githubusercontent.com/google-github-actions/run-zero-cli';
...
// Add ZERO CLI specific entries to .gitignore file
export async function updateGitignore(gitRepoRoot: string): Promise<void> {
  const gitignoreEntries = ['.zero/', 'gha-creds-*.json'];
...
export const setupGithubCommand: SlashCommand = {
  ...
  action: async (
    ...
    const readmeUrl = `https://github.com/google-github-actions/run-zero-cli/blob/${releaseTag}/README.md#quick-start`;
    ...
    return {
      ...
      toolArgs: {
        description:
          'Setting up GitHub Actions to triage issues and review PRs with ZERO.',
        command,
      },
    };
  },
