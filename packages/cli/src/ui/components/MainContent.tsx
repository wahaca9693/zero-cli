...
import { MAX_ZERO_MESSAGE_LINES } from '../constants.js';
...
// Limit ZERO messages to a very high number of lines to mitigate performance
// issues in the worst case if we somehow get an enormous response from ZERO.
...
export const MainContent = () => {
      ...
      augmentedHistory.map(
        ({
          ...
          <MemoizedHistoryItemDisplay
            ...
            availableTerminalHeightZERO={MAX_ZERO_MESSAGE_LINES}
            key={item.id}
            item={item}
            isPending={false}
  ...
  // interactive. ZERO messages and Tool results that are not scrollable,
