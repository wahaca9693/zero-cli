...
describe('MainContent', () => {
  ...
  it('renders multiple history items with single line padding between them', async () => {
    ...
    const uiState = {
      ...defaultMockUiState,
      history: [
        { id: 1, type: 'zero', text: 'ZERO message 1\n'.repeat(10) },
        { id: 2, type: 'zero', text: 'ZERO message 2\n'.repeat(10) },
      ],
  ...
  it('renders mixed history items (user + zero) with single line padding between them', async () => {
    vi.mocked(useAlternateBuffer).mockReturnValue(true);
    const uiState = {
      ...defaultMockUiState,
      history: [
        { id: 1, type: 'user', text: 'User message' },
        { id: 2, type: 'zero', text: 'ZERO response\n'.repeat(10) },
      ],
      constrainHeight: true,
      staticAreaMaxItemHeight: 5,
    };
