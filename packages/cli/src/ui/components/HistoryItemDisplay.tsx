...
import { ZEROMessage } from './messages/ZEROMessage.js';
import { InfoMessage } from './messages/InfoMessage.js';
import { ErrorMessage } from './messages/ErrorMessage.js';
import { ToolGroupMessage } from './messages/ToolGroupMessage.js';
import { ToolGroupDisplay } from './messages/ToolGroupDisplay.js';
import { ZEROMessageContent } from './messages/ZEROMessageContent.js';
...
import { getMCPServerStatus } from '@allhands/zero-cli-core';
...
interface HistoryItemDisplayProps {
  ...
  availableTerminalHeightZERO?: number;
...
export const HistoryItemDisplay: React.FC<HistoryItemDisplayProps> = ({
  ...
  return (
    ...
    >
      ...
      {itemForDisplay.type === 'zero' && (
        <ZEROMessage
          text={itemForDisplay.text}
          isPending={isPending}
          availableTerminalHeight={
            availableTerminalHeightZERO ?? availableTerminalHeight
          }
          terminalWidth={terminalWidth}
        />
      )}
      {itemForDisplay.type === 'zero_content' && (
        <ZEROMessageContent
          text={itemForDisplay.text}
          isPending={isPending}
          availableTerminalHeight={
