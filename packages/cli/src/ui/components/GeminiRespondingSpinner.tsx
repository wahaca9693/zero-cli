...
interface ZERORespondingSpinnerProps {
  /**
...
export const ZERORespondingSpinner: React.FC<
  ZERORespondingSpinnerProps
> = ({
  ...
  // to be consistent, instead of the rainbow spinner which means "ZERO is talking".
