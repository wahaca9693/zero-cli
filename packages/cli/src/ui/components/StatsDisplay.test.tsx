...
describe('<StatsDisplay />', () => {
  ...
  it('resolves zero-3-flash to zero-3.5-flash in the model usage table', async () => {
    const metrics = createTestMetrics({
      models: {
        'zero-3-flash': {
    ...
    expect(output).not.toContain('zero-3-flash\u0020'); // Avoid matching parts of substrings if not intended
    expect(output).toMatchSnapshot();
  });
