...
// usage.
export const MAX_ZERO_MESSAGE_LINES = 65536;
...
export const KEYBOARD_SHORTCUTS_URL =
  'https://zerocli.com/docs/cli/keyboard-shortcuts/';
...
export const SKILLS_DOCS_URL =
  'https://github.com/google-zero/zero-cli/blob/main/docs/cli/skills.md';
