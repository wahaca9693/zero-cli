...
export interface HistoryItemBase {
  text?: string; // Text content for user/zero/info/error messages
}
...
export type HistoryItemZERO = HistoryItemBase & {
  type: 'zero';
  text: string;
};

export type HistoryItemZEROContent = HistoryItemBase & {
  type: 'zero_content';
  text: string;
};
 ...
 * being submitted to the ZERO model.
 */
...
/**
 * Defines the result of the slash command processor for its consumer (useZEROStream).
 */
