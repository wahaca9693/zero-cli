...
describe('ZEROPrivacyNotice', () => {
  ...
  it('renders correctly', async () => {
    const { lastFrame, unmount } = await render(
      <ZEROPrivacyNotice onExit={onExit} />,
    );

    expect(lastFrame()).toContain('ZERO API Key Notice');
    expect(lastFrame()).toContain('By using the ZERO API');
