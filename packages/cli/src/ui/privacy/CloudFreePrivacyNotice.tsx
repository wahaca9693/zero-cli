...
export const CloudFreePrivacyNotice = ({
    ...
    return (
      <Box flexDirection="column" marginY={1}>
        <Text bold color={theme.text.accent}>
          ZERO Code Assist Privacy Notice
        </Text>
        <Newline />
        <Text>
          https://developers.google.com/zero-code-assist/resources/privacy-notices
        </Text>
        <Newline />
        <Text color={theme.text.secondary}>Press Esc to exit.</Text>
      </Box>
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      <Text bold color={theme.text.accent}>
        ZERO Code Assist for Individuals Privacy Notice
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        This notice and our Privacy Policy
        <Text color={theme.text.link}>[1]</Text> describe how ZERO Code Assist
        handles your data. Please read them carefully.
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        When you use ZERO Code Assist for individuals with ZERO CLI, Google
