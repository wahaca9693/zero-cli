        ...
        addItem(
          {
            ...
            text: 'This folder is untrusted, project settings, hooks, MCPs, and ZERO.md files will not be applied for this folder.\nUse the `/permissions` command to change the trust level.',
          },
          Date.now(),
        );
    ...
    async (choice: FolderTrustChoice) => {
      ...
      try {
        ...
        coreEvents.emitFeedback(
          'error',
          'Failed to save trust settings. Exiting ZERO CLI.',
        );
        setTimeout(async () => {
