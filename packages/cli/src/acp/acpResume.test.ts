...
import { convertSessionToClientHistory } from '@allhands/zero-cli-core';
...
describe('ZEROAgent Session Resume', () => {
  ...
  it('should load a session, resume chat, and stream all message types', async () => {
    ...
    expect(response).toEqual({
      ...
      models: {
        ...
        currentModelId: 'zero-pro',
      },
    });

    // Verify resumeChat received the correct arguments
    expect(mockConfig.getZEROClient().resumeChat).toHaveBeenCalledWith(
      mockClientHistory,
