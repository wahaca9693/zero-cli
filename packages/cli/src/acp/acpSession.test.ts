...
vi.mock(
  ...
  async (
    importOriginal: () => Promise<typeof import('@allhands/zero-cli-core')>,
  ) => {
...
async function* createMockStream(
  items: readonly ServerZEROStreamEvent[],
...
describe('Session', () => {
  ...
  beforeEach(() => {
    ...
    mockConfig = {
      ...
      getActiveModel: vi.fn().mockReturnValue('zero-pro'),
  ...
  it('should pass current session information directly onto zeroClient.sendMessageStream', async () => {
    const stream = createMockStream([
      {
        type: ZEROEventType.Content,
        value: 'Hello',
  ...
  it('should handle ZEROEventType.LoopDetected', async () => {
    const stream = createMockStream([
      {
  ...
  it('should handle ZEROEventType.ContextWindowWillOverflow', async () => {
    const stream = createMockStream([
      {
  ...
  it('should handle ZEROEventType.MaxSessionTurns', async () => {
    const stream = createMockStream([
      {
