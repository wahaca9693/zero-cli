...
import { debugLogger, type SkillDefinition } from '@allhands/zero-cli-core';
...
async function extensionConsentString(
  ...
  if (sanitizedConfig.contextFileName) {
    output.push(
      `This extension will append info to your zero.md context using ${sanitizedConfig.contextFileName}`,
    );
  }
