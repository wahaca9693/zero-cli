  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show ZERO CLI model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
      ...
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running ZERO CLI in the home directory.',
        showInDialog: true,
      },
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (ZERO.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
  ...
  context: {
    ...
    properties: {
      ...
      memoryBoundaryMarkers: {
        ...
        description:
          'File or directory names that mark the boundary for ZERO.md discovery. ' +
      ...
      loadMemoryFromIncludeDirectories: {
        ...
        default: false,
        description: oneLine`
          Controls how /memory reload loads ZERO.md files.
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          customIgnoreFilePaths: {
            ...
            default: [] as string[],
            description:
              'Additional ignore file paths to respect. These files take precedence over .zeroignore and .gitignore. Files earlier in the array take precedence over files later in the array, e.g. the first file takes precedence over the second one.',
            showInDialog: true,
            items: { type: 'string' },
            mergeStrategy: MergeStrategy.UNION,
          },
        ...
        properties: {
          ...
          backend: {
            ...
            description: oneLine`
              ...
              ZERO Live backend, voice recordings are sent to Google Cloud for
              transcription.
            `,
            showInDialog: true,
            options: [
              { value: 'zero-live', label: 'ZERO Live API (Cloud)' },
      ...
      gemmaModelRouter: {
        ...
        properties: {
          enabled: {
            ...
            default: false,
            description:
              'Enable the Gemma Model Router (experimental). Requires a local endpoint serving Gemma via the ZERO API using LiteRT-LM shim.',
            showInDialog: true,
          },
          autoStartServer: {
            type: 'boolean',
            ...
            default: false,
            description:
              'Automatically start the LiteRT-LM server when ZERO CLI starts and the Gemma router is enabled.',
            showInDialog: true,
          },
          binaryPath: {
            type: 'string',
            ...
            default: '',
            description:
              'Custom path to the LiteRT-LM binary. Leave empty to use the default location (~/.zero/bin/litert/).',
            showInDialog: false,
          },
          classifier: {
            type: 'object',
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the ZERO CLI extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for ZERO CLI.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling ZERO CLI output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
        ...
        items: {
          ...
          properties: {
            condition: {
              type: 'object',
              properties: {
                useZERO3_1: { type: 'boolean' },
                useZERO3_1FlashLite: { type: 'boolean' },
