...
describe('Policy Engine Integration Tests', () => {
  beforeEach(() => vi.stubEnv('ZERO_SYSTEM_MD', ''));
    ...
    describe.each(['write_file', 'replace'])(
      ...
      (toolName) => {
        it(`should allow ${toolName} to plans directory`, async () => {
          ...
          const validPaths = [
            '/home/user/.zero/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/session-1/plans/my-plan.md',
            '/home/user/.zero/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/session-1/plans/feature_auth.md',
            '/home/user/.zero/tmp/new-temp_dir_123/session-1/plans/plan.md', // new style of temp directory
            'C:\\Users\\user\\.zero\\tmp\\project-id\\session-id\\plans\\plan.md',
            'D:\\zero-cli\\.zero\\tmp\\project-id\\session-1\\plans\\plan.md', // no session ID
          ];
        ...
        it(`should deny ${toolName} outside plans directory`, async () => {
          ...
          const invalidPaths = [
            ...
            '/home/user/.zero/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/script.js', // Wrong extension
            '/home/user/.zero/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/../../../etc/passwd.md', // Path traversal (Unix)
            'C:\\Users\\user\\.zero\\tmp\\id\\session\\plans\\..\\..\\..\\Windows\\System32\\config\\SAM', // Path traversal (Windows)
            '/home/user/.zero/non-tmp/new-temp_dir_123/plans/plan.md', // outside of temp dir
          ];
