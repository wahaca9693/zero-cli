...
ZERO CLI extension. It demonstrates how to expose tools and prompts to the
ZERO CLI.
...
- `zero-extension.json`: The configuration file that tells ZERO CLI how to
  use this extension.
...
This example is typically used by `zero extensions new`.
