  ...
  return {
    ...
    Storage: Object.assign(
      vi.fn().mockImplementation((_cwd: string) => ({
        getGlobalSettingsPath: () => '/tmp/zero/settings.json',
        getWorkspaceSettingsPath: () => '/tmp/zero/workspace-settings.json',
        getProjectTempDir: () => '/test/home/.zero/tmp/mocked_hash',
      })),
      {
        getGlobalSettingsPath: () => '/tmp/zero/settings.json',
        getGlobalZERODir: () => '/tmp/zero',
      },
    ),
    ZERO_DIR: '.zero',
