...
const EVENT_CHAT_COMPRESSION = 'zero_cli.chat_compression';
const TOOL_CALL_COUNT = 'zero_cli.tool.call.count';
const TOOL_CALL_LATENCY = 'zero_cli.tool.call.latency';
const API_REQUEST_COUNT = 'zero_cli.api.request.count';
const API_REQUEST_LATENCY = 'zero_cli.api.request.latency';
const TOKEN_USAGE = 'zero_cli.token.usage';
const SESSION_COUNT = 'zero_cli.session.count';
const FILE_OPERATION_COUNT = 'zero_cli.file.operation.count';
const LINES_CHANGED = 'zero_cli.lines.changed';
const INVALID_CHUNK_COUNT = 'zero_cli.chat.invalid_chunk.count';
const CONTENT_RETRY_COUNT = 'zero_cli.chat.content_retry.count';
const CONTENT_RETRY_FAILURE_COUNT =
  'zero_cli.chat.content_retry_failure.count';
const NETWORK_RETRY_COUNT = 'zero_cli.network_retry.count';
const MODEL_ROUTING_LATENCY = 'zero_cli.model_routing.latency';
const MODEL_ROUTING_FAILURE_COUNT = 'zero_cli.model_routing.failure.count';
const MODEL_SLASH_COMMAND_CALL_COUNT =
  'zero_cli.slash_command.model.call_count';
const EVENT_HOOK_CALL_COUNT = 'zero_cli.hook_call.count';
const EVENT_HOOK_CALL_LATENCY = 'zero_cli.hook_call.latency';
const KEYCHAIN_AVAILABILITY_COUNT = 'zero_cli.keychain.availability.count';
const TOKEN_STORAGE_TYPE_COUNT = 'zero_cli.token_storage.type.count';
const OVERAGE_OPTION_COUNT = 'zero_cli.overage_option.count';
const CREDIT_PURCHASE_COUNT = 'zero_cli.credit_purchase.count';
const EVENT_ONBOARDING_START = 'zero_cli.onboarding.start';
const EVENT_ONBOARDING_SUCCESS = 'zero_cli.onboarding.success';
const EVENT_ONBOARDING_DURATION_MS = 'zero_cli.onboarding.duration';

// Agent Metrics
const AGENT_RUN_COUNT = 'zero_cli.agent.run.count';
const AGENT_DURATION_MS = 'zero_cli.agent.duration';
const AGENT_TURNS = 'zero_cli.agent.turns';
const AGENT_RECOVERY_ATTEMPT_COUNT = 'zero_cli.agent.recovery_attempt.count';
const AGENT_RECOVERY_ATTEMPT_DURATION =
  'zero_cli.agent.recovery_attempt.duration';

// Browser Agent Metrics
const BROWSER_AGENT_CONNECTION_DURATION =
  'zero_cli.browser_agent.connection.duration';
const BROWSER_AGENT_CONNECTION_FAILURE_COUNT =
  'zero_cli.browser_agent.connection.failure.count';
const BROWSER_AGENT_TOOLS_DISCOVERED =
  'zero_cli.browser_agent.tools.discovered';
const BROWSER_AGENT_TOOLS_MISSING_SEMANTIC =
  'zero_cli.browser_agent.tools.missing_semantic';
const BROWSER_AGENT_VISION_STATUS = 'zero_cli.browser_agent.vision.status';
const BROWSER_AGENT_TASK_OUTCOME = 'zero_cli.browser_agent.task.outcome';
const BROWSER_AGENT_TASK_DURATION = 'zero_cli.browser_agent.task.duration';
const BROWSER_AGENT_CLEANUP_DURATION =
  'zero_cli.browser_agent.cleanup.duration';
const BROWSER_AGENT_CLEANUP_FAILURE_COUNT =
  'zero_cli.browser_agent.cleanup.failure.count';
...
const STARTUP_TIME = 'zero_cli.startup.duration';
const MEMORY_USAGE = 'zero_cli.memory.usage';
const CPU_USAGE = 'zero_cli.cpu.usage';
const EVENT_LOOP_DELAY = 'zero_cli.event_loop.delay';
const TOOL_QUEUE_DEPTH = 'zero_cli.tool.queue.depth';
const TOOL_EXECUTION_BREAKDOWN = 'zero_cli.tool.execution.breakdown';
const TOKEN_EFFICIENCY = 'zero_cli.token.efficiency';
const API_REQUEST_BREAKDOWN = 'zero_cli.api.request.breakdown';
const PERFORMANCE_SCORE = 'zero_cli.performance.score';
const REGRESSION_DETECTION = 'zero_cli.performance.regression';
const REGRESSION_PERCENTAGE_CHANGE =
  'zero_cli.performance.regression.percentage_change';
const BASELINE_COMPARISON = 'zero_cli.performance.baseline.comparison';
const FLICKER_FRAME_COUNT = 'zero_cli.ui.flicker.count';
const SLOW_RENDER_LATENCY = 'zero_cli.ui.slow_render.latency';
const EXIT_FAIL_COUNT = 'zero_cli.exit.fail.count';
const PLAN_EXECUTION_COUNT = 'zero_cli.plan.execution.count';
...
export function recordModelRoutingMetrics(
  ...
  if (event.reasoning) {
    ...
    const isStrictTelemetry =
      process.env['ZERO_STRICT_TELEMETRY_LIMITS'] === 'true';
