  ...
  describe('GcpLogExporter', () => {
    ...
    describe('constructor', () => {
      it('should create a log exporter with project ID', () => {
        expect(exporter).toBeDefined();
        expect(mockLogging.log).toHaveBeenCalledWith('zero_cli');
      });
    ...
    describe('export', () => {
      ...
      it('should truncate payload strictly if ZERO_STRICT_TELEMETRY_LIMITS is true', async () => {
      ...
      it('should completely bypass truncation if ZERO_STRICT_TELEMETRY_LIMITS is false or unset', async () => {
        const largeArray = Array(60).fill('a'.repeat(10000));
