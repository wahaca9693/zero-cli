...
export const SERVICE_NAME = 'zero-cli';
export const SERVICE_DESCRIPTION =
  'ZERO CLI is an open-source AI agent that brings the power of ZERO directly into your terminal. It is designed to be a terminal-first, extensible, and powerful tool for developers, engineers, SREs, and beyond.';

// ZERO CLI specific semantic conventions
...
// ZERO CLI specific operations
export enum ZEROCliOperation {
  ToolCall = 'tool_call',
  LLMCall = 'llm_call',
