...
export const EVENT_CLI_CONFIG = 'zero_cli.config';
export class StartSessionEvent implements BaseTelemetryEvent {
  ...
  constructor(config: Config, toolRegistry?: ToolRegistry) {
    ...
    if (generatorConfig && generatorConfig.authType) {
      useZERO = generatorConfig.authType === AuthType.USE_ZERO;
    ...
    this.api_key_enabled = useZERO || useVertex;
...
export const EVENT_USER_PROMPT = 'zero_cli.user_prompt';
...
export const EVENT_TOOL_CALL = 'zero_cli.tool_call';
...
export const EVENT_API_REQUEST = 'zero_cli.api_request';
...
export const EVENT_API_ERROR = 'zero_cli.api_error';
...
export const EVENT_API_RESPONSE = 'zero_cli.api_response';
...
export const EVENT_FLASH_FALLBACK = 'zero_cli.flash_fallback';
...
export const EVENT_RIPGREP_FALLBACK = 'zero_cli.ripgrep_fallback';
...
export const EVENT_NEXT_SPEAKER_CHECK = 'zero_cli.next_speaker_check';
...
export const EVENT_CONSECA_POLICY_GENERATION =
  'zero_cli.conseca.policy_generation';
...
export const EVENT_CONSECA_VERDICT = 'zero_cli.conseca.verdict';
...
export const EVENT_SLASH_COMMAND = 'zero_cli.slash_command';
...
export const EVENT_REWIND = 'zero_cli.rewind';
...
export const EVENT_CHAT_COMPRESSION = 'zero_cli.chat_compression';
...
export const EVENT_IDE_CONNECTION = 'zero_cli.ide_connection';
...
export const EVENT_CONVERSATION_FINISHED = 'zero_cli.conversation_finished';
...
export const EVENT_FILE_OPERATION = 'zero_cli.file_operation';
...
export const EVENT_INVALID_CHUNK = 'zero_cli.chat.invalid_chunk';
...
export const EVENT_CONTENT_RETRY = 'zero_cli.chat.content_retry';
...
export const EVENT_NETWORK_RETRY_ATTEMPT = 'zero_cli.network_retry_attempt';
...
export const EVENT_MODEL_ROUTING = 'zero_cli.model_routing';
...
export const EVENT_EXTENSION_INSTALL = 'zero_cli.extension_install';
...
export const EVENT_TOOL_OUTPUT_TRUNCATED = 'zero_cli.tool_output_truncated';
...
export const EVENT_TOOL_OUTPUT_MASKING = 'zero_cli.tool_output_masking';
...
export const EVENT_EXTENSION_UNINSTALL = 'zero_cli.extension_uninstall';
...
export const EVENT_EXTENSION_UPDATE = 'zero_cli.extension_update';
...
export const EVENT_EXTENSION_ENABLE = 'zero_cli.extension_enable';
...
export const EVENT_MODEL_SLASH_COMMAND = 'zero_cli.slash_command.model';
...
export const EVENT_LLM_LOOP_CHECK = 'zero_cli.llm_loop_check';
...
export const EVENT_EXTENSION_DISABLE = 'zero_cli.extension_disable';
...
export const EVENT_EDIT_STRATEGY = 'zero_cli.edit_strategy';
...
export const EVENT_EDIT_CORRECTION = 'zero_cli.edit_correction';
...
export const EVENT_STARTUP_STATS = 'zero_cli.startup_stats';
...
export const EVENT_AGENT_START = 'zero_cli.agent.start';
...
export const EVENT_AGENT_FINISH = 'zero_cli.agent.finish';
...
export const EVENT_AGENT_RECOVERY_ATTEMPT = 'zero_cli.agent.recovery_attempt';
...
export const EVENT_HOOK_CALL = 'zero_cli.hook_call';

export const EVENT_APPROVAL_MODE_SWITCH =
  'zero_cli.plan.approval_mode_switch';
...
export const EVENT_APPROVAL_MODE_DURATION =
  'zero_cli.plan.approval_mode_duration';
...
export const EVENT_PLAN_EXECUTION = 'zero_cli.plan.execution';
...
export const EVENT_KEYCHAIN_AVAILABILITY = 'zero_cli.keychain.availability';
...
export const EVENT_ONBOARDING_START = 'zero_cli.onboarding.start';
...
export const EVENT_ONBOARDING_SUCCESS = 'zero_cli.onboarding.success';
...
export const EVENT_TOKEN_STORAGE_INITIALIZATION =
  'zero_cli.token_storage.initialization';
