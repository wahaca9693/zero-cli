...
export const EVENT_OVERAGE_MENU_SHOWN = 'zero_cli.overage_menu_shown';
...
export const EVENT_OVERAGE_OPTION_SELECTED =
  'zero_cli.overage_option_selected';
...
export const EVENT_EMPTY_WALLET_MENU_SHOWN =
  'zero_cli.empty_wallet_menu_shown';
...
export const EVENT_CREDIT_PURCHASE_CLICK = 'zero_cli.credit_purchase_click';
...
export const EVENT_CREDITS_USED = 'zero_cli.credits_used';
...
export const EVENT_API_KEY_UPDATED = 'zero_cli.api_key_updated';
