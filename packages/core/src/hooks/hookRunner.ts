...
export class HookRunner {
  ...
  private async executeCommandHook(
    ...
    return new Promise((resolve) => {
      ...
      const env = {
        ...
        ZERO_PROJECT_DIR: input.cwd,
        ZERO_PLANS_DIR: this.config.storage.getPlansDir(),
        ZERO_CWD: input.cwd,
        ZERO_SESSION_ID: input.session_id,
  ...
  private expandCommand(
    ...
    return command
      .replace(/\$ZERO_PROJECT_DIR/g, () => escapedCwd)
      .replace(/\$ZERO_CWD/g, () => escapedCwd)
      .replace(/\$ZERO_PLANS_DIR/g, () => escapedPlansDir)
      .replace(/\$ZERO_SESSION_ID/g, () => escapedSessionId)
