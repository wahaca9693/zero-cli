...
export class McpClientManager {
   ...
   *    - Updates the ZERO chat configuration to load the new tools.
   */
  async stopExtension(extension: ZEROCLIExtension) {
   ...
   *    - Updates the ZERO chat configuration to load the new tools.
   */
  async startExtension(extension: ZEROCLIExtension) {
   ...
   * zero settings or command line arguments).
   *
