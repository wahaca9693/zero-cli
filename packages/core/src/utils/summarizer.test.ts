...
import { DEFAULT_ZERO_MODEL } from '../config/models.js';
...
describe('summarizers', () => {
  ...
  beforeEach(() => {
    ...
    (mockZEROClient.generateContent as Mock) = vi.fn();
  ...
  describe('summarizeToolOutput', () => {
    it('should return original text if it is shorter than maxLength', async () => {
      ...
      expect(mockZEROClient.generateContent).not.toHaveBeenCalled();
    });
    ...
    it('should call generateContent if text is longer than maxLength', async () => {
      ...
      expect(mockZEROClient.generateContent).toHaveBeenCalledTimes(1);
    ...
    it('should return original text if generateContent throws an error', async () => {
      ...
      (mockZEROClient.generateContent as Mock).mockRejectedValue(error);
...
`;
      const calledWith = (mockZEROClient.generateContent as Mock).mock
        .calls[0];
