...
import { ZEROChat } from '../core/zeroChat.js';
...
describe('checkNextSpeaker', () => {
  ...
  beforeEach(() => {
    ...
    // ZEROChat will receive the mocked instances via the mocked GoogleGenAI constructor
    chatInstance = new ZEROChat(
      mockConfig,
