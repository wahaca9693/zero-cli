...
// See: https://ai.google.dev/zero-api/docs/document-processing
...
function estimateMediaTokens(part: Part): number | undefined {
  ...
  if (mimeType?.startsWith('image/')) {
    // Images: 3,000 tokens (covers up to 4K resolution on ZERO 3)
    // See: https://ai.google.dev/zero-api/docs/vision#token_counting
 ...
 * and accounting for nested ZERO 3 multimodal parts.
 */
function estimateFunctionResponseTokens(
  ...
  // ZERO 3: Handle nested multimodal parts recursively.
