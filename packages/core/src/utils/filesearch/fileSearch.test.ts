...
describe('FileSearch', () => {
  ...
  it('should use .zeroignore rules', async () => {
    tmpDir = await createTmpDir({
      [ZERO_IGNORE_FILE_NAME]: 'dist/',
      dist: ['ignored.js'],
      src: ['not-ignored.js'],
    });
  ...
  it('should combine .gitignore and .zeroignore rules', async () => {
    tmpDir = await createTmpDir({
      '.git': {},
      '.gitignore': 'dist/',
      [ZERO_IGNORE_FILE_NAME]: 'build/',
      dist: ['ignored-by-git.js'],
      build: ['ignored-by-zero.js'],
      src: ['not-ignored.js'],
    });
