...
function buildSystemPrompt(skillsDir: string, memoryDir: string): string {
  return [
    ...
    '             file ~/.zero/ZERO.md. No other files in ~/.zero/ are',
    ...
    '',
    'Project/workspace shared instructions (ZERO.md and similar files under the',
    ...
    '',
    'NEVER directly edit MEMORY.md, ZERO.md, ~/.zero/ZERO.md, settings,',
