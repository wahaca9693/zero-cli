...
// Default browser profile directory name within ~/.zero/
...
export class BrowserManager {
  ...
  private async connectMcp(): Promise<void> {
    ...
    // - "persistent": Persistent profile at ~/.zero/cli-browser-profile/ (default)
    ...
    if (browserConfig.customConfig.profilePath) {
      ...
      // Default persistent profile lives under ~/.zero/cli-browser-profile
