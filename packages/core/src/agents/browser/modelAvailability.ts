 ...
 */
export const VISUAL_AGENT_MODEL = 'zero-2.5-computer-use-preview-10-2025';

/**
 * Pattern matching the zero computer-use model family.
 * These models require a computerUse tool declaration in every request.
 */
const COMPUTER_USE_MODEL_PATTERN = /^zero-.*-computer-use-/;

/**
 * Returns true if the model name belongs to the computer-use family
 * (matches zero-*-computer-use-*).
 */
