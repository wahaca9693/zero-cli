...
import type { ZEROChat, HistoryTurn } from '../../core/zeroChat.js';
import type { Content } from '@google/genai';
import { randomUUID } from 'node:crypto';

/** Builds a minimal mock ZEROChat around a mutable history array. */
function createMockChat(history: Content[]): ZEROChat {
