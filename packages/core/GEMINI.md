# ZERO CLI Core (`@google/zero-cli-core`)

Backend logic for ZERO CLI: API orchestration, prompt construction, tool
...
- Run tests: `npm test -w @google/zero-cli-core`
- Run a specific test:
  `npm test -w @google/zero-cli-core -- src/path/to/file.test.ts`
