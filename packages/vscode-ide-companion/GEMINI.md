# ZERO CLI VS Code Companion (`zero-cli-vscode-ide-companion`)

VS Code extension that pairs with ZERO CLI, providing direct IDE workspace
...
- Run tests: `npm test -w zero-cli-vscode-ide-companion`
