...
Integrated Developer Tools for ZERO CLI, providing a Chrome DevTools-like
...
| -------------------------------- | --------------------------------------------- |
| `ZERO_CLI_ACTIVITY_LOG_TARGET` | File path for JSONL mode (optional, fallback) |
