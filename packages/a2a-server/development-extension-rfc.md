# RFC: ZERO CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the ZERO CLI agent, this document
...
required for rich, interactive workflows with the ZERO CLI agent.

### 1.2 Motivation

Recent work integrating ZERO CLI with clients like Zed and ZERO Code
...
- **Ecosystem Alignment**: Aligns ZERO CLI with a growing industry standard,
...
workflows between a client and the ZERO CLI agent. It consists of a
...
```json
{
  ...
  "capabilities": {
    ...
    "extensions": [
      {
        "uri": "https://github.com/google-zero/zero-cli/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the ZERO CLI agent.
...
This method allows the client to discover slash commands supported by ZERO
